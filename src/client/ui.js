  ...
  return `<footer class="site-footer">
    <div class="site-footer__inner">
      <div class="site-footer__socials" aria-label="CUPI social links">
        ${LOGIN_SOCIALS.map(([label, href, path]) => `<a href="${href}" target="_blank" rel="noreferrer" aria-label="${label}"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="${path}"/></svg></a>`).join('')}
      </div>
