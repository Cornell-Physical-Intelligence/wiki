...
`This is CUPI's internal knowledge base. Everything we learn the hard way gets written down here, from CAD conventions to board bring-up rituals to flight test procedure, so the next person doesn't have to relearn it.

![Crab on the beach](/welcome-crab.png "The apply-page crab. Physical intelligence, demonstrated.")
...
`The wiki is plain Markdown with extras built for how a hardware team documents things.
...
Every save is a revision with a diff, and anything can be restored, so edit boldly. Deleted pages sit in Trash for 30 days.`),
...
Don't check boxes here. **Duplicate it** (••• menu → Duplicate), rename your copy to *Onboarding: Your Name*, and tick things off there.

:::

## Accounts and access

- [ ] Sign in to the wiki (you did, you're reading this)
