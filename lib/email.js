...
const CRAB_IMG = 'https://cornellphysicalintelligence.com/img/CrabOnBeach-380.webp';
...
export async function sendWelcome({ to, addedByName, host }) {
  ...
  <div style="font-family:system-ui,-apple-system,'Segoe UI',sans-serif;max-width:520px;margin:0 auto;color:#141414">
    ...
    <p style="color:#777;font-size:13px">Sign in with your ${to} Google account — access is already set up, no code needed. If you weren't expecting this, ignore it.</p>
  </div>`;
  try {
