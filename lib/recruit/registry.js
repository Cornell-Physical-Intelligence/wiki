...
const PARAMS = {
  cycle: 'cy-[a-z0-9-]+', app: 'in-[a-z0-9]+', file: 'int-[a-z0-9]+', comment: 'ic-[a-z0-9-]{8,80}', email: '[^/]{3,200}', receipt: 'jr-\\d{13}-[a-f0-9]{24}', member: '[^/]{3,200}', module: '[a-z]+', section: '[a-z][a-z0-9_-]{0,39}',
};
