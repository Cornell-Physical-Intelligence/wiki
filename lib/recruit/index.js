...
// submissions, the people behind them, per-cycle roles, and the website endpoints. Add a module by
...
export const { MODULES, handleRecruit, intakeBridge, kitFor } = createRecruit([cycles, applications, people, roles, site]);
