// Builds docs/index.html — the whole app in preview mode for GitHub Pages:
// same client, sign-in simulated, data in the visitor's browser. The Vercel
// deployment (scripts/build.mjs + api/) is the real multi-user version.
...
console.log('docs/index.html', html.length, 'bytes');
