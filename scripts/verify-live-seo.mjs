...
assert(locs.length === 1 && locs[0] === `${WIKI_URL}/`, 'live sitemap does not list exactly the root');
...
console.log('Live wiki SEO verification passed: indexable shell, crawl files, favicon, gated API.');
